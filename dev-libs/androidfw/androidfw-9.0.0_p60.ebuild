...
SRC_URI="https://android.googlesource.com/platform/frameworks/base/+archive/refs/tags/android-${MY_PV}/libs/androidfw.tar.gz -> ${P}.tar.gz
...
src_unpack() {
	unpack_into "${P}.tar.gz" frameworks/base/libs/"${PN}"
...
src_install() {
	dolib.so lib${PN}.so
	doheader -r frameworks/base/libs/${PN}/include/${PN}
}
