...
DESCRIPTION="Android Asset Packaging Tool 2.0"
...
src_compile() {
	protoc --cpp_out=. frameworks/base/tools/aapt2/Resources.proto
	protoc --cpp_out=. frameworks/base/tools/aapt2/Configuration.proto
	protoc --cpp_out=. frameworks/base/tools/aapt2/ResourcesInternal.proto
